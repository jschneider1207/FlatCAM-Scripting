...
class KiCadProject:
    ...
    def load(dir: str) -> KiCadProject:
        ...
        if not output_path.is_dir():
            return "Project output directory not found. Ensure the project contains a directory named 'out'."
        ...
        if gerber_files.count() == 0:
            return 'No gerber files found in output directory. Did you forget to plot the board?'
